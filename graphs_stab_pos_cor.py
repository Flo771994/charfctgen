...
for dim in ["2","5","10"]:
    for alpha in ["0.5","1"]:
        ...
        # Load model
        filenamemodel="saved_models/alpha_stab_pos_cor_"+str(alpha)+"_"+str(dim)+"-dim_300_50widths_02-08-2024.pth"
        ...
        filenamespdmatrix="saved_models/params_alpha_stab_pos_cor_"+str(alpha)+"_"+str(dim)+"-dim_02-08-2024.npz"#"saved_models/params_alpha_stab_"+str(alpha)+"_"+str(dim)+"-dim_22-07-2024.npz"
        ...
        with torch.no_grad():
            ...
            #print(latex_table)
            with open(f"Latex/table_{alpha}_stab_pos_cor_{dim}_dim_quantiles.txt", "w") as f:
                f.write(latex_table)
            ...
            # Print or save the LaTeX table
            #print(latex_table)
            with open(f"Latex/table_{alpha}_stab_pos_cor_{dim}_dim_losses.txt", "w") as f:
                f.write(latex_table)
